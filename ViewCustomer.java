...
public class ViewCustomer extends JFrame implements ActionListener {
    ...
    ViewCustomer(String username) {
        ...
        labeladdress.setBounds(600, 100, 150, 25);
        add(labeladdress);
        ...
        labelphone.setBounds(600, 150, 150, 25);
        add(labelphone);
